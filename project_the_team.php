...
?>
		...
		<div id="content">
			...
			<div id="body">
				<p>With a combination of distinguished achievements in the commercial sphere, expertise in management and planning skills, individual experiences of Business School training and a profound understanding of Iranian culture, this team is ideally suited to undertake and successfully overcome the challenges set by a project of this scale. </p>
				<span class="name">Dr. Zahed Sheikholeslami – Executive Dean</span>
				<span class="cv">Zahed was the Director of the project-based Learning Institute and the Director of Corporate Relations for the College of Engineering at the California Polytechnic State University (CalPoly).  Prior to joining CalPoly, Zahed was the Vice President of Business Development for Mikros Technologies in New Hampshire, USA.  Early in his career, Zahed was the Director of Marketing for ‘Create’, a research and development consulting firm based in New Hampshire, until 1992, when he joined a software start-up called Flomerics, Inc.  in Massachusetts.  Zahed was the President of Flomerics from 1993 to 2000, where under his leadership the company's revenue grew ten-fold.  In 2000 he left his position to start a new company, CoolingZone.  Zahed was the co-founder of Sharif University of Technology Association and was its president from 2004 to 2006. He is also the President of the International Association of Iranian Managers (I-AIM).  Over the past decade, Zahed has successfully conducted many workshops in Iran in strategic management and entrepreneurship.  Zahed received his BS Degree in Mechanical Engineering from Sharif University of Technology and earned a PhD from the University of Iowa in computational fluid dynamics.  He is IBS’s Executive Dean and is based in Tehran. </span>
				...
				<span class="name">Reza Moradi-Aliarabi (Project Managing Director)</span>
				...
				<span class="name">Peyman Dadgar</span>
				<span class="cv">Peyman holds a BSc (Hons) in Computer Science and a Master's Degree in Business Information Systems from the University of London. He began his professional career in quantitative finance at Barclays Capital and Deutsche Bank and currently works in the investment banking division of Citigroup. Peyman has also worked as a Strategy and Management consultant to a number of start-up companies in the Middle East.</span>
				<span class="name">Alieh Ashtari (Project Director)</span>
				<span class="cv">Alieh has an MSc in Engineering from Isfahan University of Technology. She has established two successful businesses and worked as Managing Director in those companies for over 10 years. She was a member of the Board of Directors of Isfahan Venture Capital Fund, as well as an active member of the Isfahan Provincial Think-Tank Centre. Additionally, she was a project member in the 'infoDev Programme', a global development programme within the World Bank. Prior to that, Alieh was teaching at university level.</span>
				<span class="name">Special Advisor: Professor Michael Hay</span>
