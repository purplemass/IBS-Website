...
?>
		...
		<div id="content">
			<div id="title">
				<div class="text">Giving to the IBS Project</div>
			</div>
			<div id="body">
<!-- 				<p class="intitle">Giving to the IBS Project</p> -->
				<p>IBS Management is a <a href="http://www.charitycommission.gov.uk" rel="new">UK registered charity</a> (Charity Number: 1125584) established for the sole purpose of undertaking global fundraising and providing the financial support required to launch the Iranian Business School.</p>
