...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<div id="margin">&nbsp;</div>
		<div id="nav">
			<div id="navitem0"><a class="navitem active" href="index.html">Home</a></div>
		...
		<div id="top">
			...
			<div id="image"><img src="assets/images/image_home.jpg" width="750" height="140" alt="Main Image" /></div>
		</div>
		<div id="main">
			<div id="menuleft">&nbsp;</div>
			<div id="content">
				<div id="title">
					<div class="text">Buying Tickets</div>
				</div>
				<div id="body">
...
//                $full_addr = $address1.','.$address2.','.$address3.','.$city.','.$post_code;
                ...
                <p>Thank you. Please check the details below and click <b><i>Buy Now</i></b> to continue to checkout.</p>

                <table>
                <tr><td><b>Email Address</b>     </td><td><?php echo $email_address ?></td></tr>
<!--
                <tr><td><b>Name</b>              </td><td><?php echo $full_name ?></td></tr>
                <tr><td><b>Address</b>           </td><td><?php echo $address1 ?></td></tr>
                <tr><td>                         </td><td><?php echo $address2 ?></td></tr>
                <tr><td>                         </td><td><?php echo $address3 ?></td></tr>
                <tr><td>                         </td><td><?php echo $city ?></td></tr>
                <tr><td>                         </td><td><?php echo $post_code ?></td></tr>
-->
                ...
                <tr><td><b>Guest List</b>        </td><td><?php echo $guest_list ?></td></tr>
                </table>
                ...
                <input type="hidden" name="hosted_button_id" value="1087249">
...
<!--
                <input type="hidden" name="on2_1" value="Name">
                <input type="hidden" name="os2_1" value="<?php // echo $full_name ?>">
                <input type="hidden" name="on3_1" value="Address">
                <input type="hidden" name="os3_1" value="<?php // echo $full_addr ?>">
-->

                <input type="hidden" name="currency_code" value="GBP">
                
                <input type="hidden" name="upload" value="1">
                <input type="hidden" name="business" value="ibs_1260112518_biz@yahoo.com">
			...
			<div id="menuright">
				...
				<div id="subscribe">
					<form id="subscriptionform" action="">
						...
						&nbsp;<a href="#" id="submit" class="button"><img src="assets/images/go.gif" alt="GO" /></a>
						</p>
					</form>
					<div id="error"></div>
					<div id="success">Your email address is now registered.<br /><br />You will start receiving our newsletter shortly.</div>
				</div>
