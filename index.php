...
?>
		<div id="content">
			...
			<div id="body">
				...
				<p><a href="project_the_team.php#steering_commitee">The Founders and Executive Committee Members</a> of the Iranian Business School Project invite you to join us in the endeavour to proactively improve and facilitate the competitiveness of the Iranian economy of tomorrow.</p>
			</div>
		</div>
<?php
