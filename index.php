...
?>
		<div id="content">
			...
			<div id="body">
				...
				<p><br />The Founders (<a href="project_the_team.php#steering_commitee">Steering Committee Members</a>) of the Iranian Business School Project invite you to join us in the endeavour to proactively improve and facilitate the competitiveness of the Iranian economy of tomorrow.</p>
				<!-- VIDEO: end -->
			</div>
		</div>
<?php
